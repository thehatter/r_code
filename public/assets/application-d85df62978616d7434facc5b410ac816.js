...
(function() {
  jQuery(function() {
    var catSorting;
    catSorting = function() {
      return $('.catalog_categoryes').sortable({
        axis: 'y',
        update: function() {
    ...
    return document.addEventListener("page:change", catSorting);
  });
...
(function() {
  jQuery(function() {
    var menuSorting;
    menuSorting = function() {
      return $('.menu_edit_page .config_menu_links').sortable({
        axis: 'y',
        update: function() {
          return $.post($(this).data('update-url'), $(this).sortable('serialize'));
        }
    ...
    return document.addEventListener("page:change", menuSorting);
  });
