...
ActiveRecord::Schema.define(version: 20150427113241) do
  ...
  add_index "up_files", ["catalog_item_id"], name: "index_up_files_on_catalog_item_id", using: :btree
  add_index "up_files", ["site_id"], name: "index_up_files_on_site_id", using: :btree
